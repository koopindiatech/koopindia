          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-12 bg-white rounded-3xl p-8 border border-slate-200 max-w-5xl mx-auto">
              ...
              <p className="text-gray-700 italic mb-4 leading-relaxed">
                "Great experience working with Koop India for website
                development. The team was responsive, delivered on time, and
                created a professional, user-friendly website that matched my
                expectations."
              </p>
              ...
              <p className="text-sm text-gray-600">Rishikesh Herbs Natural</p>
            </div>
          </div>
        </section>
