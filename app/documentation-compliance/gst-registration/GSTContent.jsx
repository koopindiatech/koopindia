...
// Head/SEO handled in page.jsx server component
import {
  CheckCircle,
  ArrowRight,
  ShieldCheck,
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#141D32] mt-2 mb-5">
                  ...
                  <span className="block text-lg font-semibold text-gray-500 mt-2">Your complete guide to GST Number, GSTIN & online registration in India</span>
                </h2>
